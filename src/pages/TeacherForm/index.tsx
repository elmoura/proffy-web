...
function TeacherForm() {
    ...
    function handleCreateClass (event: FormEvent) {
        ...
        console.log({name, avatar, whatsapp, bio, cost, subject, scheduleItems});

    }

    function setScheduleItemValue(position: number, field: string, value: string) {

        const updatedScheduleItems: any = scheduleItems.map((scheduleItem: object, index) => {
                ...
                <form onSubmit={handleCreateClass}>
                    ...
                    <footer>
                        ...
                        <p>
                            ...
                            Importante: preencha todos os seus dados<br />
                        </p>
